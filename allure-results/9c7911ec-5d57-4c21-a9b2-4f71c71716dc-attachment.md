      ...
      - navigation [ref=e43]:
        - list [ref=e44]:
          ...
          - listitem [ref=e53] [cursor=pointer]:
            - generic [ref=e54]: "Improve this code: const expe..."
            - button [ref=e56]:
              - img [ref=e57]
          - listitem [ref=e61] [cursor=pointer]:
            - generic [ref=e62]: what do we call this in python...
            - button [ref=e64]:
              - img [ref=e65]
          ...
          - listitem [ref=e77] [cursor=pointer]:
            - generic [ref=e78]: What is the capital of Nepal
            - button [ref=e80]:
              - img [ref=e81]
          ...
          - listitem [ref=e93] [cursor=pointer]:
            - generic [ref=e94]: Generate a React login page wi...
            - button [ref=e96]:
              - img [ref=e97]
          - listitem [ref=e101] [cursor=pointer]:
            - generic [ref=e102]: Explain Kafka.
            - button [ref=e104]:
              - img [ref=e105]
          - listitem [ref=e109] [cursor=pointer]:
            - generic [ref=e110]: Explain Azure DevOps.
            - button [ref=e112]:
              - img [ref=e113]
          - listitem [ref=e117] [cursor=pointer]:
            - generic [ref=e118]: Explain Docker.
            - button [ref=e120]:
              - img [ref=e121]
          - listitem [ref=e125] [cursor=pointer]:
            - generic [ref=e126]: Generate text using தமிழ், हिं...
            - button [ref=e128]:
              - img [ref=e129]
          - listitem [ref=e133] [cursor=pointer]:
            - generic [ref=e134]: Generate an article containing...
            - button [ref=e136]:
              - img [ref=e137]
          - listitem [ref=e141] [cursor=pointer]:
            - generic [ref=e142]: Generate an article containing...
            - button [ref=e144]:
              - img [ref=e145]
          - listitem [ref=e149] [cursor=pointer]:
            - generic [ref=e150]: Generate 100 python interview ...
            - button [ref=e152]:
              - img [ref=e153]
          - listitem [ref=e157] [cursor=pointer]:
            - generic [ref=e158]: Write 200 SQL interview questi...
            - button [ref=e160]:
              - img [ref=e161]
          - listitem [ref=e165] [cursor=pointer]:
            - generic [ref=e166]: Generate 100 Java coding inter...
            - button [ref=e168]:
              - img [ref=e169]
          - listitem [ref=e173] [cursor=pointer]:
            - generic [ref=e174]: Explain every AWS service in d...
            - button [ref=e176]:
              - img [ref=e177]
          - listitem [ref=e181] [cursor=pointer]:
            - generic [ref=e182]: What is the capital of Nepal
            - button [ref=e184]:
              - img [ref=e185]
          ...
          - listitem [ref=e197] [cursor=pointer]:
            - generic [ref=e198]: What is the capital of Nepal
            - button [ref=e200]:
              - img [ref=e201]
          ...
          - generic [ref=e246]:
            - generic [ref=e247]:
              ...
              - list [ref=e251]:
                ...
                - listitem [ref=e256]:
                  - text: 📊
                  - strong [ref=e257]: Information & summaries
                - listitem [ref=e258]:
                  - text: ❓
                  - strong [ref=e259]: General knowledge questions
              - paragraph [ref=e260]: Just let me know what you need!
              - paragraph [ref=e261]: Is there a specific task or project you're working on that I can assist you with?
            - generic [ref=e262]:
        ...
        - generic [ref=e274]:
          - generic [ref=e277]:
            - button [ref=e278] [cursor=pointer]:
              - img [ref=e280]
            - textbox "Start your request, and let KAI handle everything" [ref=e282]
            - generic [ref=e283]:
              - generic [ref=e284] [cursor=pointer]:
                - generic [ref=e285]: claude-sonnet-4.6
                - img [ref=e287]
              - button [ref=e289] [cursor=pointer]:
                - img [ref=e291]
              - button [disabled] [ref=e294]:
                - img [ref=e296]
          - generic [ref=e299]: K-AI is AI-powered. double-check for accuracy.
