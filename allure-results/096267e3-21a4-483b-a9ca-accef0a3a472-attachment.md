...
```ts
  ...
  72  | 
  73  |     const difference = Math.abs(previousData.analysisResultsPrevious - analysisResults)
  74  |     console.log(`Difference: ${difference}`);
> 75  |     expect(difference).toBeLessThanOrEqual(10);
      |                        ^ Error: expect(received).toBeLessThanOrEqual(expected)
  76  | 
  77  |     
  78  | // const difference = Math.abs(
  79  | //     previousData.analysisResultsPrevious - analysisResults
  80  | // );
  81  | 
  82  | 
  83  | // expect(
  84  | //     difference,
  85  | //     `Difference (${difference}) exceeds allowed threshold of 10`
  86  | // ).toBeLessThanOrEqual(10);
  87  | 
  88  | 
  89  | 
  90  |     // Delete old file
  ...
  93  | else {
  94  |   
  95  | const currentData = {
  96  |     analysisResultsPrevious: analysisResults
  97  | };
  98  | 
  99  | // Save latest data for next execution
  100 | fs.writeFileSync(
  101 |     filePath,
  102 |     JSON.stringify(currentData, null, 2)
  103 | );
  104 | 
  105 | }
  106 | 
